...
handleTrainingMode (e) {
  ...
  this.setState( prevState => ({ newSession : 
 {...prevState.newSession, trainingMode : value
 }
...
handleNetworkType (e) {
  let value = e.target.value;
  this.setState( prevState => ({ newSession : 
 {...prevState.newSession, networkType : value
 }
 }), () => console.log(this.state.newSession))
}
        ...
        <Container id="home-container">
          ...
          <div class = "mode-selector">
                ...
                <div id="mode-selector-switch">
                    ...
                    <input 
                        id="basic-selector-option" class="input-hidden" type="radio" onChange={this.handleTrainingMode} checked={this.state.newSession.trainingMode === 'basic'} value="basic"
                        />
                    <label for="basic-selector-option">
                        <p>&nbsp;&nbsp;&nbsp;&nbsp;Basic&nbsp;&nbsp;&nbsp;&nbsp;</p>
                    </label>
                    <input 
                        id="advanced-selector-option" class="input-hidden" type="radio" onChange={this.handleTrainingMode} checked={this.state.newSession.trainingMode === 'advanced'} value="advanced"
                        />
          ...
          {(this.state.step==0 && this.state.newSession.trainingMode=='basic') && <button className='btn btn-primary' style={buttonStyle}>Start training</button>}
          {(this.state.step==0 && this.state.newSession.trainingMode=='advanced') && <button className='btn btn-primary' style={buttonStyle} onClick={this.nextStep}>Next</button>}
          ...
          <div id="mode-selector-switch">
              <div id="mode-selector-option">
              <input 
                  id="mlp-selector-option" class="input-hidden" type="radio" onChange={this.handleNetworkType} checked={this.state.newSession.networkType === 'MLP'} value="MLP"
                  />
              <label for="mlp-selector-option">
                  <p>Multilayer Perceptrons</p>
              </label>
              <input 
                  id="cnn-selector-option" class="input-hidden" type="radio" onChange={this.handleNetworkType} checked={this.state.newSession.networkType === 'CNN'} value="CNN"
                  />
              <label for="cnn-selector-option">
                  <p>Convolutional Neural Network</p>
              </label>
              <input 
                  id="lstm-selector-option" class="input-hidden" type="radio" onChange={this.handleNetworkType} checked={this.state.newSession.networkType === 'LSTM'} value="LSTM"
                  />
          ...
          {this.state.step==1 && <Link to='/networksettings' ><button className='btn btn-primary' style={buttonStyle}>Build network</button></Link>}
        </Container>
